...
@Getter
public class EmailMessageInboxPlaceholderSummarise extends EmailMessageInboxPlaceholderBase 
{
	@Getter static private final String MONITOR_TAG_STRING = "Summarise";
	@Getter(lazy=true) private final String inboxMonitorString = initEmailMonitorString();

	@Override
	protected String getSubject() {
		return String.valueOf("Automation Monitor Tag Email - Summarise");
	}
	...
	private String initEmailMonitorString()
	{
		...
		stringBuilder.append(EmailMessageInboxPlaceholderSummarise.getMONITOR_TAG_STRING());
