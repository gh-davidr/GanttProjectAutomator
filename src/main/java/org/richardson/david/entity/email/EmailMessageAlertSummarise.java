...
@Getter
public class EmailMessageAlertSummarise extends EmailMessageAlertBase
{
	public EmailMessageAlertSummarise(@NonNull Message message) {
		super("Summarise", 
				UserConfig.getInstance().getHelp().getAlertEmail(),
				message);
	}
}
