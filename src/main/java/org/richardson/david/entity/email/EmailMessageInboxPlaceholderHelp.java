...
@Getter
public class EmailMessageInboxPlaceholderHelp extends EmailMessageInboxPlaceholderBase 
{
	@Getter static private final String MONITOR_TAG_STRING = "Help";
	@Getter(lazy=true) private final String inboxMonitorString = initEmailMonitorString();

	@Override
	protected String getSubject() {
		return String.valueOf("Automation Monitor Tag Email - Help");
	}
	...
	private String initEmailMonitorString()
	{
		...
		stringBuilder.append(EmailMessageInboxPlaceholderHelp.getMONITOR_TAG_STRING());
