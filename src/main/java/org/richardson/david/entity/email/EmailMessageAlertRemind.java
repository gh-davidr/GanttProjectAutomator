...
public class EmailMessageAlertRemind extends EmailMessageAlertBase
{
	public EmailMessageAlertRemind(@NonNull Message message) {
		super("Remind", 
				UserConfig.getInstance().getRemind().getAlertEmail(),
				message);
	}
}
