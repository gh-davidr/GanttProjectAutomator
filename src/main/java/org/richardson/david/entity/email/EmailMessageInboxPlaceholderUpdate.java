...
@Getter
public class EmailMessageInboxPlaceholderUpdate extends EmailMessageInboxPlaceholderBase 
{
	@Getter static private final String MONITOR_TAG_STRING = "Update";
	@Getter(lazy=true) private final String inboxMonitorString = initEmailMonitorString();

	@Override
	protected String getSubject() {
		return String.valueOf("Automation Monitor Tag Email - Update");
	}
	...
	private String initEmailMonitorString()
	{
		...
		stringBuilder.append(EmailMessageInboxPlaceholderUpdate.getMONITOR_TAG_STRING());
