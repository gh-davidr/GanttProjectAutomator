...
@Getter
public class EmailMessageInboxPlaceholderRemind extends EmailMessageInboxPlaceholderBase 
{
	@Getter static private final String MONITOR_TAG_STRING = "Remind";
	@Getter(lazy=true) private final String inboxMonitorString = initEmailMonitorString();
	
	@Override
	protected String getSubject() {
		return String.valueOf("Automation Monitor Tag Email - Remind");
	}
	...
	private String initEmailMonitorString()
	{
		...
		stringBuilder.append(EmailMessageInboxPlaceholderRemind.getMONITOR_TAG_STRING());
