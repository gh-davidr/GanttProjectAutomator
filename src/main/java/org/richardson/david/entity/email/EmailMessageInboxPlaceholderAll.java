...
@Getter
public class EmailMessageInboxPlaceholderAll extends EmailMessageInboxPlaceholderBase 
{
	@Getter static private final String MONITOR_TAG_STRING = "All Responses";
	@Getter(lazy=true) private final String inboxMonitorString = initEmailMonitorString();

	@Override
	protected String getSubject() {
		return String.valueOf("Automation Monitor Tag Email - All Responses");
	}
	...
	private String initEmailMonitorString()
	{
		...
		stringBuilder.append(EmailMessageInboxPlaceholderAll.getMONITOR_TAG_STRING());
