...
public class Tasks {
    ...
    @XmlAttribute(name = "empty-milestones") private String emptyMilestones;

    @XmlElement(name = "taskproperties")   private TaskProperties taskProperties;
	
    @XmlElement(name="task") private ArrayList<Task> tasks;    
}
