...
public class DayTypes {
	@XmlElement(name="day-type") private ArrayList<DayType> dayTypes;
	@XmlElement(name="default-week") private DefaultWeek defaultWeek;
	@XmlElement(name="only-show-weekends") private OnlyShowWeekends onlyShowWeekends;
	@XmlElement(name="overriden-day-types") private OverriddenDayTypes overriddenDayTypes;
	@XmlElement(name="days") private Days days;
}
