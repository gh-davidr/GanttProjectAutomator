...
@Data
public class UserConfigSummarise {

	private String  projectManager;
	private Long    summaryFutureDays;
	...
	public String toString()
	{
		...
		sBuilder.append(""
				...
				+ "<ul>"
				+ "<li>" + "<b>Project Manager     :</b> " + getProjectManager() + "</li>\r\n" 
				+ "<li>" + "<b>Summary Future Days :</b> " + getSummaryFutureDays() + "</li>\r\n" 
