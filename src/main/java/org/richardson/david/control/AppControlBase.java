...
public class AppControlBase 
{
	@Getter(lazy=true) private final String runMode = initRunMode();
	
	private String initRunMode()
	{
		return "(" + AppControl.getInstance().getRunModeString() + ") ";
	}
}
