...
import org.richardson.david.entity.gantt.Roles;
...
public class TestEntityRoles extends TestEntityBase {
	...
	void test1() {
		...
		try {
			...
			element = (Roles)unmarshaller.unmarshal(stringToStream(TEST1_XML_PROPERTY_String));
		}
		catch (Exception e)
		{
			element = null;
		...
		Assertions.assertTrue(element != null && element.getRolesetName().equals("Default"));
	}
